...
export class CompetitionVoteService {
    ...
    getVoteByMemberAndProfile(memberId: string, profileId): Observable<CompetitionVoteReturnTO> {
        return this.http.get<CompetitionVoteReturnTO>(this.api + memberId + '/profile/' + profileId);
    }
